...
1. Download or Clone the Repository
   ...
   - Or clone using Git:
     ```bash
     git clone https://github.com/brenan02/brenan02.github.io.git
     ```

2. Open the Project Folder
   - Open the extracted folder in File Explorer or VS Code.
...
Video on Homepage:
https://www.youtube.com/watch?v=1n2Z2YeKj7M
